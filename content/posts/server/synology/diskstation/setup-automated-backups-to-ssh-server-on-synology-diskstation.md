...
aliases = ["/blog/2014/07/12/how-to-replace-a-bad-hard-drive-on-a-synology-diskstation-raid-5-with-dsm-5-0", "/server/synology/diskstation/setup-automated-backups-to-ssh-server-on-synology-disktation"]
